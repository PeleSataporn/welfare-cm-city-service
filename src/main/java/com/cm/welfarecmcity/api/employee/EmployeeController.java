...
public class EmployeeController {
    ...
    public ResponseModel<SearchDataResponse<EmpByAdminRes>> searchEmployeeByAdmin(@RequestBody RequestModel<EmployeeByAdminReqDto, EmployeeByAdminOrderReqDto> req) throws SQLException {
