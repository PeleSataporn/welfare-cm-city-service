...
public class Calculate {
  ...
  public static double calculateLoanInstallment(
      double principal, double interestRate, int numOfPayments) {
  ...
  public static void createAmortizationTable(
      double principal,
      double interestRate,
      int numOfPayments,
      double installment,
    ...
    System.out.println("\nAmortization Table:");
    System.out.println(
        "Payment\t\tDate\t\tInterest\tPrincipal\t\tInstallment\t\tBalance\t\tNumber of Day\t\tTotal Deduction");
  ...
  //
  //        double[][] installmentSchedule = calculateInstallmentSchedule(loanAmount, interestRate,
  // loanDuration, startDate);
  ...
  //    }
  //
  //    public static double[][] calculateInstallmentSchedule(double loanAmount, double
  // interestRate, int loanDuration, LocalDate startDate) {
